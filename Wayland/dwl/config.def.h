...
static const float focuscolor[]            = COLOR(0xFFAD00ff);
...
static const char *const autostart[] = {
        "someblocks", NULL,
        "swaybg", "-i", "/home/rogerio/Images/Wallpapers/mountain.jpeg", "-m", "fill", NULL,
        "dunst", NULL,
        NULL /* terminate */
};
...
static const char *menucmd[] = { "wmenu-run", "-N", "1B1B1B", "-n", "FFFFFF", "-S", "FFAD00", "-s", "1B1B1B", "-l", "7", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_Return,     setlayout,      {.v = &layouts[0]} },
